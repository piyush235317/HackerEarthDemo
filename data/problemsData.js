export const problemsData = [
  ...
  },
  {
    ...
    "title": "What will be the output of the following pseudo-code?",
    "snippet": "BEGIN\n  x ← 5\n  y ← 2\n  result ← 0\n  WHILE x > 0 DO\n    result ← result + y\n    x ← x - 1\n  END WHILE\n  PRINT result\nEND",
    "type": "MCQ",
    "score": "4.00",
    "options": [
  ...
  },
  {
    "id": 9,
    "category": "Aptitude & Reasoning",
    "title": "Pointing to a photograph of a man, a woman said: 'His mother is the only daughter of my mother.' How is the woman related to the man in the photograph?",
    "snippet": null,
    "type": "MCQ",
    "score": "2.00",
    "options": [
  ...
  },
  {
    ...
    "score": "2.00",
    "options": [
      "54 and 6/11 minutes past 4",
      "52 and 8/11 minutes past 4",
      "50 and 5/11 minutes past 4",
      "55 minutes past 4"
    ],
    "correctAnswer": 0
  },
  {
    "category": "Programming",
    "title": "Analyze the following pseudo-code and determine the final value of 'count':",
    "snippet": "BEGIN\n  count ← 0\n  FOR i ← 1 TO 10 DO\n    IF i MOD 2 = 0 THEN\n      count ← count + i\n    END IF\n  END FOR\n  PRINT count\nEND",
    "type": "MCQ",
    "score": "4.00",
    "options": [
  ...
  {
    "category": "Programming",
    "title": "What does the following recursive pseudo-code return when called with n = 5?",
  ...
  {
    "category": "Programming",
    "title": "What is the output of the following pseudo-code that uses an array?",
  ...
  },
  {
    ...
    "score": "2.00",
    "options": [
      "All are perfect cubes, none is odd in cube series (if square property tested: 64 and 729 are also squares)",
      "125 is the only non-composite number",
      "343 is divisible by 9",
      "None of the above"
    ],
    "correctAnswer": 0
  },
  ...
  {
    "category": "Programming",
    "title": "Trace through the following pseudo-code. What is printed?",
    "snippet": "BEGIN\n  a ← 1\n  b ← 1\n  FOR i ← 1 TO 6 DO\n    temp ← b\n    b ← a + b\n    a ← temp\n  END FOR\n  PRINT b\nEND",
    "type": "MCQ",
    "score": "4.00",
    "options": [
  ...
  },
  {
    ...
    "score": "2.00",
    "options": [
      "To enable direct gradient flow to earlier layers, mitigating vanishing gradients",
      "To reduce the total parameter count and memory footprint of the model",
      "To replace spatial pooling layers for dimensionality reduction",
      "To enforce non-linear feature transformations between adjacent blocks"
    ],
    "correctAnswer": 0
  },
  {
  ...
  },
  {
    ...
    "score": "2.00",
    "options": [
      "LayerNorm computes statistics across features within each sample independently of batch size and padding",
      "LayerNorm computes statistics across the mini-batch dimension, making it faster on GPUs",
      "Batch Normalization cannot be computed when running in mixed-precision FP16 mode",
      "LayerNorm eliminates the need for learnable affine scale and shift parameters"
    ],
    "correctAnswer": 0
  },
  {
  ...
  },
  {
    ...
    "score": "2.00",
    "options": [
      "It decouples weight decay directly from gradient updates and moving average calculations",
      "It dynamically updates learning rates using second-order Hessian approximations",
      "It replaces exponential moving averages with linear step decay",
      "It clips gradients adaptively according to their Euclidean norm"
    ],
    "correctAnswer": 0
  },
  {
  ...
  },
  {
    ...
    "score": "2.00",
    "options": [
      "All neurons remain active, and weights are scaled by the retention probability (1 - p)",
      "Neurons are still randomly dropped with probability p",
      "Dropout increases activation values by 1 / (1 - p)",
      "Weights are set to zero if their activation falls below a threshold"
    ],
    "correctAnswer": 0
  },
  {
    ...
    "score": "2.00",
    "options": [
      "The generator produces a very limited variety of outputs that deceive the discriminator",
      "The discriminator loss drops to zero, stalling further generator training",
      "The learning rate decays too quickly, freezing network weights",
      "The generator produces only pure noise that fails all discrimination thresholds"
    ],
    "correctAnswer": 0
  },
  {
  ...
  },
  {
    ...
    "score": "2.00",
    "options": [
      "Higher T flattens the probability distribution across all classes",
      "Higher T makes the distribution sharper towards the top prediction",
      "Lower T increases diversity and randomness in generation",
      "T acts strictly as a regularization penalty on model weights"
    ],
    "correctAnswer": 0
  },
  {
    ...
    "score": "2.00",
    "options": [
      "Significantly reduces FLOPs and parameters by separating spatial filtering from channel mixing",
      "Increases model capacity by computing 3D convolutions across all channels simultaneously",
      "Eliminates the requirement for non-linear activation functions",
      "Enables exact mathematical invertibility of convolutional operations"
    ],
    "correctAnswer": 0
  },
  {
  ...
  },
  {
    ...
    "score": "2.00",
    "options": [
      "A differently augmented view (crop, color jitter) of the exact same image",
      "An image selected from the same class label in the dataset",
      "The reconstructed output generated by a masked autoencoder",
      "A nearest-neighbor image retrieved using Euclidean distance in feature space"
    ],
    "correctAnswer": 0
  },
  {
    ...
    "score": "2.00",
    "options": [
      "To prevent exploding gradients that cause numerical overflow and unstable weight updates",
      "To prevent the learning rate from decaying too rapidly",
      "To eliminate the need for recurrent hidden state propagation",
      "To force the gradient of inactive neurons to zero"
    ],
    "correctAnswer": 0
  },
  {
    ...
    "score": "2.00",
    "options": [
      "VAEs encode inputs into parameters of a probability distribution (mean and variance) in latent space",
      "VAEs do not require a decoder network to reconstruct original data",
      "Standard Autoencoders enforce a Gaussian prior over the bottleneck representations",
      "VAEs can only be trained with unsupervised clustering algorithms like K-Means"
    ],
    "correctAnswer": 0
  },
  {
    ...
    "score": "2.00",
    "options": [
      "The region in the input image that directly contributes to a specific unit's activation",
      "The number of filters contained within a single convolutional layer",
      "The total memory footprint required to store feature activations during the forward pass",
      "The maximum resolution of images that can be fed into the network"
    ],
    "correctAnswer": 0
  },
  {
    ...
    "score": "2.00",
    "options": [
      "Unfreezing some pre-trained layers and training with a small learning rate on target data",
      "Training only the newly added classification head while keeping all other layers completely frozen forever",
      "Retraining all network weights from scratch with random initialization on the target dataset",
      "Pruning zero-weight connections to compress the model for edge deployment"
    ],
    "correctAnswer": 0
  },
  {
    ...
    "score": "2.00",
    "options": [
      "Inserting spaces (holes) between kernel elements according to a dilation rate",
      "Cascading multiple 1x1 convolutions sequentially",
      "Dynamically increasing the stride during the forward pass",
      "Sharing weights across both spatial dimensions and channel dimensions"
    ],
    "correctAnswer": 0
  },
  {
    ...
    "score": "2.00",
    "options": [
      "To inject information about token order because self-attention is permutation-invariant",
      "To normalize word embeddings so their L2 norm equals 1.0",
      "To prevent out-of-vocabulary tokens from receiving zero activations",
      "To encode sentence-level semantic labels for downstream classification"
    ],
    "correctAnswer": 0
  },
  {
  ...
  },
  {
    ...
    "score": "2.00",
    "options": [
      "It provides a smooth, non-monotonic probabilistic gating for negative values instead of a hard zero cutoff",
      "It guarantees zero gradient for all values greater than 1.0",
      "It completely removes the need for layer normalization",
      "It is computationally faster than ReLU because it requires no multiplications"
    ],
    "correctAnswer": 0
  },
  {
  ...
  },
  {
    ...
    "score": "2.00",
    "options": [
      "To filter inbound and outbound network traffic to Azure resources based on 5-tuple rules",
      "To distribute incoming web traffic across a pool of backend web servers using Layer 7 routing",
      "To provide encrypted site-to-site VPN tunnels between on-premises and Azure VNets",
      "To automatically scale compute instances based on CPU utilization metrics"
    ],
    "correctAnswer": 0
  },
  {
  ...
  },
  {
    ...
    "score": "2.00",
    "options": [
      "Stopping within guest OS leaves compute allocated, continuing compute charges; Deallocating releases hardware and halts compute charges",
      "Both actions immediately deallocate compute and prevent all billing",
      "Deallocating deletes all attached managed OS and data disks permanently",
      "Stopping within guest OS deletes the private IP configuration permanently"
    ],
    "correctAnswer": 0
  },
  {
  ...
  },
  {
    ...
    "score": "2.00",
    "options": [
      "Microsoft manages and scales the Kubernetes control plane (API server, etcd) for free; customer manages worker node pools",
      "Customer must patch and maintain the underlying Kubernetes master control plane nodes",
      "Microsoft manages customer container image source code and application deployments",
      "Customer manages physical datacenter server hardware and hypervisors"
    ],
    "correctAnswer": 0
  },
  {
    ...
    "score": "2.00",
    "options": [
      "Event Hubs is optimized for high-throughput big data streaming ingestion; Service Bus is designed for enterprise transactional messaging with queues and topics",
      "Event Hubs supports only AMQP protocol while Service Bus supports only HTTP REST",
      "Service Bus is an unmanaged serverless storage service; Event Hubs requires provisioned VMs",
      "Event Hubs guarantees FIFO message ordering with duplicate detection, whereas Service Bus cannot"
    ],
    "correctAnswer": 0
  },
  {
    ...
    "options": [
      ...
      "Timer Trigger",
      "HTTP Trigger with webhook polling",
  ...
  },
  {
    ...
    "score": "2.00",
    "options": [
      "Security Principal (User/Group/SP), Role Definition, and Scope",
      "Tenant ID, Subscription Key, and Resource Provider",
      "Management Group, Resource Group, and Tags",
      "Client Secret, Application ID, and Redirect URI"
    ],
    "correctAnswer": 0
  },
  {
    ...
    "score": "2.00",
    "options": [
      "Concise syntax, cleaner readability, modularity, and automatic dependency management without complex JSON nesting",
      "Bicep runs as an imperative scripting language like Python while ARM is declarative",
      "Bicep compiles to Kubernetes YAML rather than ARM templates",
      "Bicep requires third-party state storage backend servers like HashiCorp Consul"
    ],
    "correctAnswer": 0
  },
  {
  ...
  },
  {
    ...
    "score": "2.00",
    "options": [
      "To provide an automatically managed identity in Microsoft Entra ID for Azure resources to authenticate to services like Key Vault without hardcoding credentials",
      "To manage end-user login credentials for public consumers in consumer web apps",
      "To synchronize on-premises Active Directory Domain Controllers to Azure IaaS VMs",
      "To assign static public IP addresses to internal Azure services"
    ],
    "correctAnswer": 0
  },
  {
  ...
  },
  {
    ...
    "score": "2.00",
    "options": [
      "A private IP address from your Virtual Network, bringing the PaaS service securely inside your VNet perimeter",
      "A dedicated hardware firewall appliance inside the customer datacenter",
      "A public static IP address that bypasses Network Security Groups",
      "An automated DNS load balancer across multi-cloud regions"
    ],
    "correctAnswer": 0
  },
  {
  ...
  },
  {
    ...
    "score": "2.00",
    "options": [
      "Azure ML Compute Cluster (AmlCompute)",
      "Compute Instance (Development workstation)",
      "Attached Databricks cluster",
  ...
  },
  {
    ...
    "score": "2.00",
    "options": [
      "To prevent accidental deletion or unwanted modification of critical resources, overriding RBAC permissions",
      "To encrypt disks with customer-managed keys at rest",
      "To restrict virtual machine access to specific external IP subnets",
      "To enforce mandatory tagging conventions across all resource groups"
    ],
    "correctAnswer": 0
  },
  {
  ...
  },
  {
    ...
    "score": "2.00",
    "options": [
      "4 (counts number of set bits in 29: binary 11101)",
      "5",
      "3",
      "29"
    ],
  ...
  },
  {
    ...
    "score": "2.00",
    "options": [
      "30 (due to operator precedence: && is evaluated before ||)",
      "50",
      "15",
      "20"
    ],
  ...
  },
  {
    ...
    "score": "2.00",
    "options": [
      "50 (x is 20, S.peek() is 30, x + 30 = 50 pushed and popped)",
      "40",
      "60",
      "30"
    ],
  ...
  },
  {
    ...
    "score": "2.00",
    "options": [
      "6 (Computes Greatest Common Divisor / GCD)",
      "36 (Computes LCM)",
      "1",
      "12"
    ],
  ...
  },
  {
    ...
    "score": "2.00",
    "options": [
      "LTF (Indices 5, 3, 1 correspond to L, T, F)",
      "LXTSAF",
      "XAF",
      "FAST"
    ],
  ...
  },
  {
    ...
    "score": "2.00",
    "options": [
      "15 (Secondary diagonal: M[0][2] + M[1][1] + M[2][0] = 3 + 5 + 7 = 15)",
      "15 (Primary diagonal)",
      "25",
      "18"
    ],
  ...
  },
  {
    ...
    "score": "2.00",
    "options": [
      "9 (Finds the maximum element)",
      "1 (Finds the minimum element)",
      "4 (Finds the first element)",
      "27 (Calculates sum)"
    ],
    "correctAnswer": 0
  },
  ...
  },
  {
    ...
    "score": "2.00",
    "options": [
      "15 (First-In First-Out: a = 5, b = 10, a + b = 15)",
      "25",
      "35",
      "30"
    ],
  ...
  },
  {
    ...
    "score": "2.00",
    "options": [
      "25 (Sum of odd numbers: 1 + 3 + 5 + 7 + 9 = 25)",
      "55",
      "30",
      "20"
    ],
  ...
  },
  {
    ...
    "score": "2.00",
    "options": [
      "4 (XOR of pairs cancels to 0, leaving the single unique element 4)",
      "0",
      "10",
      "1"
    ],
